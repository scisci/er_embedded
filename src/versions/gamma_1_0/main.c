/* Ribbon Prototype 1.0 Board. This is designed for the first prototype vest which
 * contains 8 keys on the left side and one slider on the right side */
...
Notes   :   n/a
============================================================================*/
uint8_t process_sensors(uint8_t status_flag)
{
	return 0;
}
#endif
