/* Ribbon Prototype 1.2 Board. This is designed for the second prototype vest
 * which contains 16 keys on the left side and 3 sliders on the right side */
...
static void configure_sensors(void) {
  ...
  enable_slider(SLIDER_CHANNEL + 8, SLIDER_CHANNEL + 15, NO_AKS_GROUP);

  enable_slider(SLIDER_CHANNEL + 16, SLIDER_CHANNEL + 23, NO_AKS_GROUP);
}
