...
/*----------------------------------------------------------------------------
  this only contains the parameter definitions that are shared between ribbon_globals.h and ribbon_api.h
----------------------------------------------------------------------------*/
...
#define ER_GLOBAL_PARAM_DEFS() {ER_ADDRESS_DEF,\
								ER_DI_DEF,\
								ER_MAX_ON_DEF,\
								ER_POS_DRIFT_DEF,\
								ER_NEG_DRIFT_DEF,\
								ER_DRIFT_HOLD_DEF,\
								ER_RECAL_DEF,\
								ER_POS_RECAL_DELAY_DEF,\
								ER_DATA_INTERVAL_DEF,\
								ER_MEASURE_PERIOD_MS_DEF }
...
#define ER_SENSOR_PARAM_DEFS() {ER_THRESHOLD_DEF,\
								ER_HYSTERESIS1_DEF,\
								ER_HYSTERESIS2_DEF,\
								ER_RESOLUTION_DEF}
